...
var R6API = (function () {
    function R6API(options) {
        ...
        this.findById = function (platform, query) {
            return checkQueryLimit({ method: findById_1.default, platform: platform, query: query, limit: 50 });
        };
        ...
        this.parseToken = auth_1.parseToken;
