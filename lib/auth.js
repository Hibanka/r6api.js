...
exports.setTokenFileLocation = exports.setCredentials = exports.getToken = exports.login = void 0;
var os_1 = require("os");
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    return [2, res];
                                case 2: throw new errors_1.UnknownAuthorizationError('No response from login: ' + JSON.stringify(res));
                            }
                        });
                    }); })
                        .catch(function (err) {
...
exports.getToken = function () { return exports.login().then(function (auth) { return "Ubi_v1 t=" + auth.ticket; }); };
exports.setCredentials = function (email, password) {
    credentials.email = email;
    credentials.password = password;
};
exports.setTokenFileLocation = function (dir) {
