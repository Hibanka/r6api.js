...
exports.default = (function (id, options) { return __awaiter(void 0, void 0, void 0, function () {
    var raw, locale, fallbackLocale, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, fetch_1.default(utils_1.URLS.NEWSBYID(id, locale, fallbackLocale))()];
            case 1:
                res = _a.sent();
                return [2, (__assign(__assign(__assign({}, raw && { raw: res }), { total: res.total, limit: res.limit, categories: res.categoriesFilter, media: res.mediaFilter, skip: res.skip, startIndex: res.startIndex, placement: res.placementFilter, tags: res.tags }), res.items && {
                        item: {
                            id: res.items.id,
