...
exports.STATS_CATEGORIES = exports.WEAPONS = exports.WEAPONTYPES = exports.OPERATORS = exports.OLD_RANKS = exports.RANKS = exports.SEASONS = exports.OLD_SEASONS = exports.REGIONS = exports.PLATFORMSALL = exports.PLATFORMS = exports.SANDBOXES = exports.SPACE_IDS = exports.API_VERSIONS = exports.STATUS_API_URL = exports.ALT_API_URL = exports.BASE_API_URL = exports.GITHUB_ASSETS_URL = exports.CDN_BASE_URL = exports.AVATAR_BASE_URL = void 0;
exports.AVATAR_BASE_URL = 'https://ubisoft-avatars.akamaized.net';
exports.CDN_BASE_URL = 'https://staticctf.akamaized.net';
exports.GITHUB_ASSETS_URL = 'https://github.com/danielwerg/r6api.js/raw/typescript/assets';
exports.BASE_API_URL = 'https://public-ubiservices.ubi.com';
exports.ALT_API_URL = 'https://www.ubisoft.com';
exports.STATUS_API_URL = 'https://game-status-api.ubisoft.com';
...
exports.PLATFORMSALL = __spread(exports.PLATFORMS, ['steam']);
exports.REGIONS = {
...
exports.OLD_SEASONS = {
    1: {
        ...
        releaseDate: new Date('2016-02-02')
    },
    2: {
        name: 'Dust Line',
        color: '#d0a344',
    ...
    5: {
        ...
        releaseDate: new Date('2017-02-07')
    }
};
exports.SEASONS = {
    6: {
    ...
    7: {
        ...
        releaseDate: new Date('2017-09-05')
    },
    8: {
        name: 'White Noise',
        color: '#006543',
    ...
    12: {
        ...
        releaseDate: new Date('2018-12-04')
    },
    13: {
        name: 'Burnt Horizon',
        color: '#d2005a',
    ...
    15: {
        ...
        releaseDate: new Date('2019-09-11')
    },
    16: {
        name: 'Shifting Tides',
        color: '#089eb3',
...
['pvp', 'pve'].map(function (type) {
    return Object.values(exports.OPERATORS).map(function (operator) {
        return operator.uniqueAbility
            && operator.uniqueAbility.stats.map(function (ability) {
                return STATS[type].operators.push("operator" + type + "_" + ability.id);
            });
    });
});
